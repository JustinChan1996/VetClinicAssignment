...
public class VetClinicConsole {
    ...
    public static void DeletePet(VetClinic vc)
    {
        ...
        try
        {
            ...
            for(int i = 0; i < vc.getPets().size(); i = i + 1)
            {
                if(vc.getPets().get(i).getPetID() == IdOfPet)
                {
                    pos = i;
                }
            }
            ...
            {
                System.out.println();
                System.out.println(vc.getPets().get(pos));
                input.nextLine();
    ...
    public static void DisplayPet(VetClinic vc)
    {
        ...
        if (order.equalsIgnoreCase("i"))
        {
            ...
            for (int i = 0; i < vc.getPets().size();i = i + 1 )
            {
                System.out.println(vc.getPets().get(i));
            }
        }
        else if (order.equalsIgnoreCase("ii"))
        {
            ...
            ArrayList<Pet> sortArray = (ArrayList<Pet>)vc.getPets().clone();
    ...
    public static void AdministerDrug(VetClinic vc)
    {
        ...
        try
        {
            ...
            if(posOfPet != -1)
            {
                ...
                double doseOfDrug = vc.getPets().get(posOfPet).getDose();
                Dose dose = new Dose(antibiotic, now, doseOfDrug);
                vc.getPets().get(posOfPet).setDoses(dose);
    ...
    public static void ModifyPet(VetClinic vc)
    {
        ...
        try
        {
            ...
            if(position != -1)
            {
                ...
                System.out.println("pet of petId " + IdOfPet + " is found in the system ");
                System.out.println("");
                System.out.println(vc.getPets().get(position));
                input.nextLine();
                ...
                do
                {
                    ...
                    if(attributeOption.equals("1"))
                    {
                        ...
                        vc.getPets().get(position).setName(newName);
                    ...
                    else if(attributeOption.equals("2"))
                    {
                        ...
                        vc.getPets().get(position).setWeight(newWeight);
